...
void PrintMainMenu(void)
  ...
  "                                                                         \n"
  "NAME                                                                     \n"
  "  FALCON v%u.%u - An ultra-fast tool to infer metagenomic composition.   \n"
  "                                                                         \n"
  "SYNOPSIS                                                                 \n"
  ...
  "                                                                         \n"
  "      Use 'FALCON <command> -h' for help with a specific command.        \n"
  "                                                                         \n"
  "EXAMPLES                                                                 \n"
  "      FALCON meta -v -F -l 47 -Z -y pro.com reads1.fq:reads2.fq DB.fa    \n"
  "      FALCON filter -v -F -t 1.0 -o seg.txt pro.com                      \n"
  "      FALCON fvisual -v -F -o map.svg seg.txt                            \n"
  "      FALCON inter -v file1.fa:file2.fa                                  \n"
  "      FALCON ivisual -F -l lab.txt -o mat.svg mat.txt                    \n"
  "                                                                         \n"
  "COPYRIGHT                                                                \n"
...
void PrintMenuFalcon(void){
  ...
  "                                                                         \n"
  "SYNOPSIS                                                                 \n"
  "      FALCON meta [OPTION]... [FILE1]:[FILE2]:... [FILE1]:[FILE2]:...    \n"
  "                                                                         \n"
  "SAMPLE                                                                   \n"
  "      FALCON meta -v -F -l 47 -Z -y pro.com reads1.fq:reads2.fq DB.fa    \n"
  "                                                                         \n"
  ...
  "                                                                         \n"
  "      -S                   save models after learning,                   \n"
  "      -L                   load models previously saved model,           \n"
  "      -M <FILE>            model filename,                               \n"
  "      -I                   model info,                                   \n"
  "                                                                         \n"
  "      -T                   train models for future use,                  \n"
  ...
  "      MAGNET integration:                                                \n"
  "                                                                         \n"
  "      -mg                   enable MAGNET pre-filtering,                 \n"
  "                                                                         \n"
  "      Mandatory arguments:                                               \n"
  "                                                                         \n"
  "      -mf [FILE]            FASTA file to use as filter reference,       \n"
  "                                                                         \n"
  "      Non-mandatory arguments:                                           \n"
  "                                                                         \n"
  "      -mv                   verbose mode (more information),             \n"
  "      -mt [NUMBER]          similarity threshold [0.0;1.0] (default: 0.9),\n"
  "      -ml [NUMBER]          sensitivity level [1;44] (default: 36),      \n"
  "      -mi                   invert filter,                               \n"
  "      -mp [NUMBER]          portion of acceptance (default: 1),          \n"
  "                                                                         \n"
  "                                                                         \n"
  "COPYRIGHT                                                                \n"
  "      Copyright (C) 2014-2025, IEETA, University of Aveiro.              \n"
...
void PrintMenuVisual(void){
  ...
  "                                                                         \n"
  "NAME                                                                     \n"
  "      FALCON fvisual v%u.%u: a FALCON visualization tool.          \n"
  "                                                                         \n"
  "SYNOPSIS                                                                 \n"
  "      FALCON fvisual [OPTION]... [FILE]                            \n"
  "                                                                         \n"
  "SAMPLE                                                                   \n"
  "      FALCON fvisual -v -F -o map.svg seg.txt                      \n"
  "                                                                         \n"
...
void PrintMenuInterVisual(void){
  ...
  "                                                                         \n"
  "NAME                                                                     \n"
  "      FALCON ivisual v%u.%u: a FALCON visualization tool.           \n"
  "                                                                         \n"
  "SYNOPSIS                                                                 \n"
  "      FALCON ivisual [OPTION]... [FILE]                             \n"
  "                                                                         \n"
  "SAMPLE                                                                   \n"
  "      FALCON ivisual -F -l lab.txt -o mat.svg mat.txt               \n"
  "                                                                         \n"
...
void PrintVersion(void){
  ...
  "                                                                         \n"
  "             # FALCON meta            INFERENCE                          \n"
  "             # FALCON filter          SEGMENTATION                       \n"
  "             # FALCON fvisual         FILT. VISUAL.                      \n"
  "             # FALCON inter           EVALUATION                         \n"
  "             # FALCON ivisual         EVAL. VISUAL.                      \n"
  "                                                                         \n"
  "                           AUTHORS:                                      \n"
  "                                                                         \n"
